...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, colback=white, colframe=quarto-callout-warning-color-frame, arc=.35mm, coltitle=black, toptitle=1mm, colbacktitle=quarto-callout-warning-color!10!white, titlerule=0mm, bottomrule=.15mm, toprule=.15mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Cuidado!}, opacitybacktitle=0.6, bottomtitle=1mm, left=2mm, opacityback=0, rightrule=.15mm]
