...
\begin{frame}{O Problema da classificação e discriminação}
...
\begin{frame}{Discriminação em dois grupos}
...
\begin{frame}{Classificação em dois grupos - Regras de classificação}
...
\begin{frame}{Classificação em dois grupos - Ilustração}
\phantomsection\label{classificauxe7uxe3o-em-dois-grupos---ilustrauxe7uxe3o}
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{../../images/AD/discriminacao_2_grupos.jpg}}
\end{center}
\end{frame}

\begin{frame}{Classificação em dois grupos - Probabilidades de
má-classificação}
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{../../images/AD/prob_ma_class_2_pop.jpg}}
\end{center}
\end{frame}

\begin{frame}{Classificação em dois grupos - Incorporando probabilidades
a priori}
...
\begin{frame}{Classificação em dois grupos - Incorporando custos de
má-classificação}
...
\begin{frame}{Classificação em dois grupos - Custo esperado de
...
\begin{frame}{Classificação em dois grupos - casos particulares}
...
\begin{frame}{Classificação em dois grupos - Classificação pelo Teorema
de Bayes}
...
\begin{frame}{Classificação em duas população normais}
...
\begin{frame}{Discriminação em duas populações}
...
\begin{frame}{Probabilidade de classificação incorreta}
...
\begin{frame}{Classificação em \(k\) grupos}
